...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 7, 0, 
		...
		XYREF(Button_PlusPlus, 88, 172),
		XYREF(Container_Gesamtzaehler, -1, -6),
		XYREF(Container_Tageszaehler, 202, 5),
		XYREF(OutputString_ZielErreicht, 500, 150),
		XYREF(Button_MinusMinus, 286, 169),
	...
	ID(SoftKey_PlusPlus), TYPEID_SOFTKEY, COLOR(77), 1, 1, 0, 
		XYREF(IconSoftKey_PlusPlus, 4, 4),
	ID(SoftKey_Reset_Gesamtzaehler), TYPEID_SOFTKEY, COLOR_RED, 1, 1, 0, 
		XYREF(OutputString_SoftKey_Reset_Gesamtzaehler, 0, 0),
	ID(SoftKey_Reset_Tageszaehler), TYPEID_SOFTKEY, COLOR_RED, 1, 1, 0, 
		XYREF(OutputString_SoftKey_Reset_Tageszaehler, 0, 0),
	ID(SoftKey_MinusMinus), TYPEID_SOFTKEY, COLOR(76), 1, 1, 0, 
		XYREF(Icon_SoftKey_MinusMinus, 4, 4),
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(80), WORD(80), 187, 144, 1, 0, 1, 0, 
		XYREF(Icon_Button_PlusPlus, 88, 172),
